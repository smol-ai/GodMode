...
class SciteAssistant extends Provider {
	static webviewId = 'webiewSciteAssistant';
	static fullName = 'Scite Assistant';
	static shortName = 'Scite';

	static url = 'https://scite.ai/assistant';

	static handleInput(input) {
		try {
			const fullName = this.fullName;
			this.getWebview().executeJavaScript(`{
        var inputElement = document.querySelector('textarea[placeholder*="What do you need"]');
        if (!inputElement) {
